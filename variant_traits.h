...
struct variant_traits {
  ...
  struct trivial {
    ...
    static constexpr bool
        copy_ctor = (std::is_trivially_copy_constructible_v<Ts>&& ...) || (!std::is_copy_constructible_v<Ts>|| ...);
    ...
    static constexpr bool
        move_ctor = (std::is_trivially_move_constructible_v<Ts>&& ...) || (!std::is_move_constructible_v<Ts>|| ...);
